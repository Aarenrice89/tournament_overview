...
urlpatterns = [
    ...
    path("tournament/<int:pk>/", views.TournamentUpdateView.as_view(), name="detail"),
    ...
    path("teams/<int:pk>/tournaments/", views.TeamTournamentListView.as_view(), name="team-tournaments"),
