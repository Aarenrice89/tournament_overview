...
- Production uses `compose/docker-compose.production.yml`; Caddy is the only public service. Create `compose/envs/.env.production` from its example and never commit it.
